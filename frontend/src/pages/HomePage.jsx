...
function HomePage() {
    ...
    return (
        <div className='relative min-h-screen overflow-y-auto bg-gradient-to-r from-green-500/70 to-green-900/80'>
            <div className='h-full max-w-4xl mx-auto flex flex-col p-3'>
                ...
                <div className='flex-1 w-full flex items-start justify-center'>
                    <div className='w-full grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 items-stretch'>
                        ...
                        <section className='bg-green-100/40 rounded-2xl shadow-2xl shadow-amber-200/80 border border-amber-700/50 p-4 flex flex-col gap-2 justify-start h-fit'>
